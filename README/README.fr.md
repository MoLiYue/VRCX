...
[![GitHub release](https://img.shields.io/github/release/MoLiYue/VRCX.svg)](https://github.com/MoLiYue/VRCX/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/MoLiYue/VRCX/total?color=6451f1)](https://github.com/MoLiYue/VRCX/releases/latest)
[![GitHub Workflow Status](https://github.com/MoLiYue/VRCX/actions/workflows/github_actions.yml/badge.svg)](https://github.com/MoLiYue/VRCX/actions/workflows/github_actions.yml)
...
Téléchargez et exécutez le dernier programme d'installation (`VRCX_Setup.exe`) [ici](https://github.com/MoLiYue/VRCX/releases/latest).
...
- Vous voulez un nouveau look pour VRCX ? Jetez un œil aux [Thèmes (Themes)](https://github.com/MoLiYue/VRCX/wiki/Themes)
- Consultez [Build à partir de la source (Building from source)](https://github.com/MoLiYue/VRCX/wiki/Building-from-source) pour des instructions sur comment build VRCX à partir de la source.
- Pour un guide sur comment exécuter VRCX sous Linux, consultez [ici](https://github.com/MoLiYue/VRCX/wiki/Running-VRCX-on-Linux)
