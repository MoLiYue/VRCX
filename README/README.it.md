...
Scarica e installa l'ultimo installer (`VRCX_Setup.exe`) da [qui](https://github.com/MoLiYue/VRCX/releases/latest).
...
- Volete un nuovo look per VRCX? [Temi](https://github.com/MoLiYue/VRCX/wiki/Themes)
- Guarda [Building from source](https://github.com/MoLiYue/VRCX/wiki/Building-from-source) per le istruzioni su come buildare VRCX dai sorgenti.
- Per una guida su come far funzionare VRCX su Linux, vedere [qui](https://github.com/MoLiYue/VRCX/wiki/Running-VRCX-on-Linux)
