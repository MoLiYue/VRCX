...
[こちら](https://github.com/MoLiYue/VRCX/releases/latest)から最新のインストーラー (`VRCX_Setup.exe`) をダウンロードして実行してください。
...
- VRCX の変わった姿を見たい？[テーマ](https://github.com/MoLiYue/VRCX/wiki/Themes)をチェック！
- VRCX をソースからビルドするには[こちらのガイド](https://github.com/MoLiYue/VRCX/wiki/Building-from-source)をご覧ください。
- VRCX を Linux で動かすには[こちらのガイド](https://github.com/MoLiYue/VRCX/wiki/Running-VRCX-on-Linux)をご覧ください。
