...
[![Liczba pobrań](https://img.shields.io/github/downloads/MoLiYue/VRCX/total?color=6451f1)](https://github.com/MoLiYue/VRCX/releases/latest)
[![Status GitHub Workflow](https://github.com/MoLiYue/VRCX/actions/workflows/github_actions.yml/badge.svg)](https://github.com/MoLiYue/VRCX/actions/workflows/github_actions.yml)
...
Pobierz i uruchom najnowszy instalator (`VRCX_Setup.exe`) [stąd](https://github.com/MoLiYue/VRCX/releases/latest).
...
- Marzy Ci się inny wygląd? Sprawdź [Motywy](https://github.com/MoLiYue/VRCX/wiki/Themes)
- Zobacz [Poradnik budowania z kodu źródłowego](https://github.com/MoLiYue/VRCX/wiki/Building-from-source) po instrukcję jak skompilować aplikację samemu.
- Sprawdź jak uruchomić VRCX na Linuxie [tutaj](https://github.com/MoLiYue/VRCX/wiki/Running-VRCX-on-Linux)
