...
ดาวน์โหลดและติดตั้งเวอร์ชันล่าสุด (`VRCX_Setup.exe`) ได้จาก [ที่นี่](https://github.com/MoLiYue/VRCX/releases/latest)
...
- อยากเปลี่ยนลุคใหม่ให้ VRCX? ลองดู [ธีม (Themes)](https://github.com/MoLiYue/VRCX/wiki/Themes)
- ดูวิธีการ Build VRCX จากซอร์สโค้ดได้ที่ [Building from source](https://github.com/MoLiYue/VRCX/wiki/Building-from-source)
- สำหรับคู่มือการใช้งาน VRCX บน Linux ดูได้ [ที่นี่](https://github.com/MoLiYue/VRCX/wiki/Running-VRCX-on-Linux)
